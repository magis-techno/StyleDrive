...
class ComfortThresholds:
    max_abs_mag_jerk: float = 7.0
    max_abs_lat_accel: float = 4.0
    max_lon_accel: float = 2.0
    min_lon_accel: float = -3.2
    max_abs_yaw_accel: float = 1.8
    max_abs_lon_jerk: float = 3.6
    max_abs_yaw_rate: float = 0.7
