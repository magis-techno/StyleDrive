...
echo "  export OPENSCENE_DATA_ROOT=\"\/mnt/sdb/DiffusionDrive/dataset\""
echo "  export NAVSIM_DEVKIT_ROOT=\"\/mnt/sdb/StyleDrive/navsim\""
echo "  export NAVSIM_EXP_ROOT=\"\/mnt/sdb/StyleDrive/exp\""
echo "" 